              ...
              <div className="news-single__left">
                  ...
                  <div className="main-block-news__top">
                    <div className="main-block-news__text-block">
                      ...
                      <h1 className="main-block-news__title">
                        Премьер-министр Молдовы одобрил вступление страны в ЕС
                      </h1>
                    </div>
                  </div>
                  ...
                  <div className="main-block-news__image">
                    <picture>
                      <source
                        ...
                        type="image/webp"
                      />
                      <Image src={MainBlock} alt="Картинка" />
                    </picture>
                  </div>
                </div>
                <div className="news-single__content content-news-single">
                  <h2 className="content-news-single__title">
                    ...
                    condimentum erat eget mauris gravida feugiat. Cras facilisis
                    quis magna eu feugiat. Ut sit{" "}
                    <span className="blue">amet risus</span> magna.{" "}
                  </h2>
                  <div className="content-news-single__text">
                    <p className="text">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Nam condimentum erat eget mauris gravida feugiat. Cras
                      facilisis quis magna eu feugiat. Ut sit amet risus magna.
                      Curabitur ut ligula eu risus dapibus pharetra. Suspendisse
                      potenti. Suspendisse quis mattis risus, vitae tincidunt
                      magna. Donec maximus vestibulum lorem,{" "}
                      <span className="emphasis">vitae euismod turpis.</span>
                      Nulla facilisis porttitor nisi a consectetur. Nunc aliquam
                      vehicula lorem, convallis convallis neque porttitor
                      vehicula.{" "}
                    </p>
                    <p className="text">
                      Maecenas dictum diam non purus facilisis, ut egestas nulla
                      eleifend. Suspendisse{" "}
                      <span className="emphasis">non ante condimentum</span>,
                      pharetra arcu eu, mattis massa. Nam ullamcorper nisl sit
                      amet neque pretium, vel scelerisque eros dapibus. Aliquam
                      erat volutpat. In a nisl faucibus, tincidunt mi ac, ornare
                      tortor. Pellentesque felis lacus, viverra vel molestie ut,
                      viverra eu nisl.
                    </p>
                    <p className="text">
                      Nunc velit lacus, dictum non tristique non, semper in
                      massa. Aliquam sodales imperdiet dui et maximus.{" "}
                      <span className="emphasis">
                        Maecenas porta sodales arcu
                      </span>
                      , et lacinia urna bibendum sit amet. Donec non vestibulum
                      odio, eget
                    </p>
                    <blockquote className="content-news-single__quote">
                      Proin quis nulla at dui sodales varius in at felis. Donec
                      quis fringilla urna. Morbi at rhoncus urna, eget
                      ullamcorper turpis. In pretium,{" "}
                      <span className="blue">eros eu tempus laoreet.</span>
                    </blockquote>
                    <p className="text">
                      Nunc velit lacus, dictum non tristique non, semper in
                      massa. Aliquam sodales imperdiet dui et maximus.{" "}
