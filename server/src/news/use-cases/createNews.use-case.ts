...
import { favoriteNewsCategory, fullNewsModel } from '../../base/types/newsModels';
...
export class CreateNewsUseCase {
  ...
  async createNews(title: string, description: string, category: favoriteNewsCategory, img: string) {
